...
<div class="relative p-4 text-center py-10 text-xl hover:scale-105 transition-all duration-300  flex flex-col items-center w-full border border-white/[0.2] rounded-md">
   ...
   <span class="z-20 relative text-white">Mood based recommendation</span> 
   <div className="text-base text-center  text-gray-400">
    Provide you recommendation based on your mood. We got you covered for every mood you want to experience.
   </div>
</div>
</Link>
...
<svg xmlns="http://www.w3.org/2000/svg" width="1.75em" height="1.75em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5"><path d="M2 12c0 5.523 4.477 10 10 10s10-4.477 10-10S17.523 2 12 2"></path><path stroke-linejoin="round" d="M12 9v4h4"></path><circle cx="12" cy="12" r="10" stroke-dasharray=".5 3.5"></circle></g></svg>
   ...
   <span class="z-20 relative text-white">History based recommendation</span> 
   <div className="text-base text-center  text-gray-400">
    Oh I recently watched this movie and I was so happy. I want to watch somehting similar to this... sure we can do that for you.
   </div>
</div>
</Link>
...
<svg xmlns="http://www.w3.org/2000/svg" width="1.75em" height="1.75em" viewBox="0 0 24 24"><path fill="currentColor" d="M24 17.53v2.421c0 .71-.391 1.101-1.1 1.101h-5l-.057-.165L11.84 3.736c.106-.502.46-.788 1.053-.788h2.422c.71 0 1.1.391 1.1 1.1v12.38H22.9c.71 0 1.1.392 1.1 1.101zM11.034 2.947l6.337 18.104h-4.918l-1.052-3.131H6.019l-1.077 3.131H0L6.361 2.948h4.673zm-.66 10.96l-1.69-5.014l-1.541 5.015h3.23z"></path></svg>
   ...
   <span class="z-20 relative text-white">Anime list based recommendation</span> 
   <div className="text-base text-center  text-gray-400">
    But you want anime recommendation based on your overall anime list? It is fine we have that too.
   </div>
</div>
</Link>
